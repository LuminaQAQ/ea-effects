...
`;var In;class su extends ot{constructor(){super();we(this,In);const n=this.attachShadow({mode:"open"});n.innerHTML=`
            <aside class="ea-aside_wrap" part="container">
                <slot></slot>
            </aside>
        `,ye(this,In,n.querySelector(".ea-aside_wrap")),this.build(n,ru)}get width(){return this.getAttrNumber("width")||200}set width(n){this.setAttribute("width",n),X(this,In).style.width=`${n}px`}connectedCallback(){this.width=this.width}}In=new WeakMap;customElements.get("ea-aside")||customElements.define("ea-aside",su);const oa=(e,t=0)=>{let n=setTimeout(()=>{clearTimeout(n),n=null,e()},t)},Fo=e=>{e.actived=!1};function iu(e,t,n){e.forEach(Fo),t.forEach(Fo),n.forEach(Fo)}function au(e,t,n){e.forEach((o,r)=>{o.itemIndex=r,o.addEventListener("item-selected",s=>{const i=s.detail.title;iu(e,t,n),o.actived=!0,this.dispatchEvent(new CustomEvent("select",{detail:{index:r,title:i}}))})})}const lu=`
.ea-menu_wrap {
  display: flex;
  flex-direction: row;
  align-items: center;
...
`;var at,no,An;class fu extends ot{constructor(){super();we(this,at);we(this,no);we(this,An);const n=this.attachShadow({mode:"open"});n.innerHTML=`
        ...
        `,ye(this,at,n.querySelector(".ea-submenu_wrap")),ye(this,no,n.querySelector(".ea-submenu_title_wrap")),ye(this,An,n.querySelector(".ea-submenu_items_wrap")),this.build(n,cu)}get actived(){return this.getAttrBoolean("actived")}set actived(n){this.setAttribute("actived",n),X(this,at).classList.toggle("is-actived",n)}get backgroundColor(){return this.getAttribute("background-color")||"#fff"}set backgroundColor(n){this.setAttribute("background-color",n),X(this,at).style.setProperty("--normal-bgc",n)}get textColor(){return this.getAttribute("text-color")||"#303133"}set textColor(n){this.setAttribute("text-color",n),X(this,at).style.setProperty("--normal-text-color",n)}get activeTextColor(){return this.getAttribute("active-text-color")||"#409eff"}set activeTextColor(n){this.setAttribute("active-text-color",n),X(this,at).style.setProperty("--actived-text-color",n)}get disabled(){return this.getAttrBoolean("disabled")}set disabled(n){this.setAttribute("disabled",n),X(this,at).classList.toggle("is-disabled",n)}get mode(){return this.getAttribute("mode")||"horizontal"}set mode(n){this.setAttribute("mode",n),X(this,at).classList.toggle("is-vertical",n==="vertical")}connectedCallback(){this.disabled=this.disabled,this.querySelectorAll("ea-menu-item").forEach((o,r)=>{o.isSubItem=!0,o.addEventListener("item-selected",s=>{this.actived=!0})}),oa(()=>{X(this,An).style.display="block"},20)}}at=new WeakMap,no=new WeakMap,An=new WeakMap;customElements.get("ea-submenu")||customElements.define("ea-submenu",fu);const uu=`
...
.backward:hover {
  transform: translateX(-20%);
    ...
    `}}),(n,o)=>(Z(),J("section",Yd,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className},null,8,["title","code","className"])),64))]))}},Kd={class:"part"},Gd={__name:"index",setup(e){const t={};return Object.assign(t,{fill:{title:"填充",className:"fill",code:`
.fill {
...
`}}),(n,o)=>(Z(),J("section",Kd,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className},null,8,["title","code","className"])),64))]))}},Wd={class:"part"},qd={__name:"index",setup(e){const t={};return Object.assign(t,{borderFade:{title:"填充",className:"borderFade",code:`
.borderFade {
    box-sizing: border-box;
...
`}}),(n,o)=>(Z(),J("section",Wd,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className},null,8,["title","code","className"])),64))]))}},Zd={class:"part"},Jd={__name:"index",setup(e){const t={};return Object.assign(t,{shadow:{title:"阴影",className:"shadow",code:`
.borderFade {
    box-sizing: border-box;
    border: 3px solid transparent;
...
`}}),(n,o)=>(Z(),J("section",Zd,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className},null,8,["title","code","className"])),64))]))}},Qd={class:"part"},eh={__name:"index",setup(e){const t={};return Object.assign(t,{bubbleTop:{title:"气泡-上方",className:"bubbleTop",code:`
.bubbleTop {
    position: relative;
    overflow: unset;
}
...
`}}),(n,o)=>(Z(),J("section",Qd,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className},null,8,["title","code","className"])),64))]))}},th={class:"part"},nh={__name:"index",setup(e){const t={};return Object.assign(t,{curlTopLeft:{title:"折角-左上方",className:"curlTopLeft",code:`
.curlTopLeft {
    position: relative;
}
...
`}}),(n,o)=>(Z(),J("section",th,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className},null,8,["title","code","className"])),64))]))}},oh={class:"part"},rh={__name:"index",setup(e){const t={};return Object.assign(t,{bounce:{title:"跳跃",className:"bounce",code:`
.bounce:hover {
...
`}}),(n,o)=>(Z(),J("section",oh,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className},null,8,["title","code","className"])),64))]))}},sh=`
...
`}};return(o,r)=>(Z(),J(ne,null,[r[0]||(r[0]=le("h2",null,"从后面进入",-1)),le("section",ch,[(Z(),J(ne,null,Ae(t,(s,i)=>Y(Ce,{key:i,title:s.title,code:s.code,className:s.className,hasButton:!0},null,8,["title","code","className"])),64))]),r[1]||(r[1]=le("h2",null,"从后面退出",-1)),le("section",fh,[(Z(),J(ne,null,Ae(n,(s,i)=>Y(Ce,{key:i,title:s.title,code:s.code,className:s.className,hasButton:!0},null,8,["title","code","className"])),64))])],64))}},dh={class:"part"},hh={class:"part"},ph={__name:"index",setup(e){const t={bounceIn:{title:"弹跳出现",className:"bounceIn",code:`
.bounceIn {
...
`}};return(o,r)=>(Z(),J(ne,null,[r[0]||(r[0]=le("h2",null,"弹跳进入",-1)),le("section",dh,[(Z(),J(ne,null,Ae(t,(s,i)=>Y(Ce,{key:i,title:s.title,code:s.code,className:s.className,hasButton:!0},null,8,["title","code","className"])),64))]),r[1]||(r[1]=le("h2",null,"弹跳退出",-1)),le("section",hh,[(Z(),J(ne,null,Ae(n,(s,i)=>Y(Ce,{key:i,title:s.title,code:s.code,className:s.className,hasButton:!0},null,8,["title","code","className"])),64))])],64))}},gh={class:"part"},mh={class:"part"},bh={__name:"index",setup(e){const t={fadeIn:{title:"淡入",className:"fadeIn",code:`
.fadeIn {
...
`}};return(o,r)=>(Z(),J(ne,null,[r[0]||(r[0]=le("h2",null,"淡入",-1)),le("section",gh,[(Z(),J(ne,null,Ae(t,(s,i)=>Y(Ce,{key:i,title:s.title,code:s.code,className:s.className,hasButton:!0},null,8,["title","code","className"])),64))]),r[1]||(r[1]=le("h2",null,"淡出",-1)),le("section",mh,[(Z(),J(ne,null,Ae(n,(s,i)=>Y(Ce,{key:i,title:s.title,code:s.code,className:s.className,hasButton:!0},null,8,["title","code","className"])),64))])],64))}},wh={class:"part"},_h={__name:"index",setup(e){const t={flip:{title:"翻转",className:"flip",code:`
.flip {
    animation: flip .75s;
}
...
`}};return(n,o)=>(Z(),J("section",wh,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className,hasButton:!0},null,8,["title","code","className"])),64))]))}},vh={class:"part"},yh={__name:"index",setup(e){const t={lightSpeedInRight:{title:"光速-从右进入",className:"lightSpeedInRight",code:`
.lightSpeedInRight {
...
`}};return(n,o)=>(Z(),J("section",vh,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className,hasButton:!0},null,8,["title","code","className"])),64))]))}},xh={class:"part"},Eh={__name:"index",setup(e){const t={rotateIn:{title:"旋转进入",className:"rotateIn",code:`
.rotateIn {
...
`}};return(n,o)=>(Z(),J("section",xh,[(Z(),J(ne,null,Ae(t,(r,s)=>Y(Ce,{key:s,title:r.title,code:r.code,className:r.className,hasButton:!0},null,8,["title","code","className"])),64))]))}},kh=[{path:"/",redirect:"/2DTransitions",meta:{title:"主页"}},{path:"/2DTransitions",component:Vd,meta:{title:"2D 过渡动画"}},{path:"/backgroundTransitions",component:Gd,meta:{title:"背景过渡动画"}},{path:"/borderTransitions",component:qd,meta:{title:"边框过渡动画"}},{path:"/shadowAndGlowTransitions",component:Jd,meta:{title:"阴影过渡动画"}},{path:"/speechBubbles",component:eh,meta:{title:"气泡框过渡动画"}},{path:"/curls",component:nh,meta:{title:"折角过渡动画"}},{path:"/attentionSeekers",component:rh,meta:{title:"吸引眼球动画"}},{path:"/backEntrancesAndBackExits",component:uh,meta:{title:"后进后出动画"}},{path:"/bouncingEntrancesAndBouncingExits",component:ph,meta:{title:"弹出弹入动画"}},{path:"/fadeInAndFadeOut",component:bh,meta:{title:"淡入淡出动画"}},{path:"/flippers",component:_h,meta:{title:"翻转动画"}},{path:"/lightspeed",component:yh,meta:{title:"光速动画"}},{path:"/rotatingEntrances",component:Eh,meta:{title:"旋转动画"}}],_a=Vf({history:Ef(),routes:kh});_a.beforeEach((e,t,n)=>{document.title=`${e.meta.title} | Ea-effects.css`,e.hash||n()});const Cs={fontelloCSS:"https://cdn.jsdelivr.net/npm/easy-component-ui/components/ea-icon/css/fontello.css"};function Rh(e){Object.assign(Cs,e),document.dispatchEvent(new CustomEvent("configChanged",{detail:Cs}))}window.addEventListener("DOMContentLoaded",()=>{Rh({fontelloCSS:new URL("/ea-effects/ea-icon/css/fontello.css",import.meta.url).href})});Uc(Ru).use(_a).mount("#app");
